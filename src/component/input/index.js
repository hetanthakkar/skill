...
import { AwesomeIcon, IonIcon, EvilIcon, MaterialDesignIcon, OctIcon,MaterialIcon } from './icons'
    ...
    return (
      <View style={[containerCustomStyle]}>
        ...
        <View style={containerStyle}>
          <Label {...labelProps} paddingRight={iconPaddingRight} paddingLeft={iconPaddingLeft} fontSize={active?23:20}/>
    ...
    switch (Type) {
        ...
        case "material":
            ...
            case "materialicon":
              return (
                  <ClickableView rippleColor={rippleColor} style={[iconStyle, { width: iconSize, left: iconPosition === "left" ? 0 : (inputWidth - iconSize - 10), bottom: this.props.error ? 12 : 0 }]}>
                      <MaterialIcon icon={iconName} color={this.props.error && iconPosition === "left" ? (this.props.errorColor ? this.props.errorColor : "red") : iconColor} size={iconSize} onPress={onPressIcon} />
                  </ClickableView>
              );   
        default:
            return (
